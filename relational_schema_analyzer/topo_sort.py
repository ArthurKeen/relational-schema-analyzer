"""Topological sort for table ordering and circular FK detection.

Lifted from ``r2g/src/r2g/topo_sort.py``. Orders tables so that FK targets appear
before FK sources, and reports circular FK dependency chains.
"""
