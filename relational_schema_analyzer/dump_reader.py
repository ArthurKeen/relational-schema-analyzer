"""CSV dump reader (polars-backed).

Lifted from ``r2g/src/r2g/input/dump_reader.py``. Used by the CSV connector to
introspect column names/types and (optionally) stream rows. Requires the ``csv``
extra (``polars``).
"""
