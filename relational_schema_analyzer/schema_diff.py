"""Compare two PhysicalSchema objects and produce a structured diff.

Lifted from ``r2g/src/r2g/schema_diff.py``. Detects added/removed tables, column
changes, primary key changes, and foreign key changes between two schema
snapshots. Reused for fingerprinting / drift detection.
"""
