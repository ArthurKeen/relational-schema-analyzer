...
def create_connector(
    ...
    *,
    ...
    ``delimiter`` / ``has_header``). PostgreSQL and Snowflake ignore it.
    """
...
# Back-compat alias: r2g (and ported tests) call ``create_source_connector``.
create_source_connector = create_connector
