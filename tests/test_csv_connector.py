...
class TestCsvBaseDirJail:
    ...
    def test_outside_base_dir_rejected(self, tmp_path, monkeypatch):
        from relational_schema_analyzer.connectors.csv_source import CsvSourceError
    ...
    def test_session_also_jailed(self, tmp_path, monkeypatch):
        from relational_schema_analyzer.connectors.csv_source import CsvSession, CsvSourceError
